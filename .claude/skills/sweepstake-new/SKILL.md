...
6. **Offres display** — rattachement par bloc et par étape (`t_sweepstake_offer`).
   Vérifier que chaque offre rattachée est active, dans ses dates et pertinente pour du trafic US.
...
- Les impressions d'offres apparaissent dans `t_offer_event`, une par offre affichée.
